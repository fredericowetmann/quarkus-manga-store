...
@ApplicationScoped
public class CollectionFileService implements FileService {

    // ex. /Users/user/quarkus/images/collection/
    private final String PATH_USER = System.getProperty("user.home") +
        File.separator + "quarkus" +
        File.separator + "images" +
        File.separator + "collection" +  File.separator;
        ...
        try {
            String novoNomeImagem = saveFile(imagem, nomeImagem);
            collection.setImageName(novoNomeImagem);
        ...
        private String saveFile(byte[] imagem, String nomeImagem) throws IOException {
