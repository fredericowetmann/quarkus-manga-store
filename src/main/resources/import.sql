...
insert into collections (`name`, `description`, imageName) values('Mushouku Tensei', 'Um japonês NEET de 34 anos, sem nome, é despejado de sua casa após a morte de seus pais. Após alguma auto-introspecção, ele conclui que sua vida foi, em última análise, sem sentido...', 'mushoku-tensei-collection.jpeg');
insert into collections (`name`, `description`, imageName) values('Konosuba', 'A série conta a história de um garoto que é mandado para um mundo fantasioso após a sua morte...', 'konosuba-collection.png');
insert into collections (`name`, `description`, imageName) values('Evangelion', 'Em 2015, quinze anos após um cataclismo global conhecido como Segundo Impacto, o adolescente Shinji Ikari é convocado para a futurística cidade de Tóquio-3 por seu pai distante Gendo Ikari, diretor de uma força paramilitar especial chamada Nerv...', 'evangelion-collection.jpeg');
insert into collections (`name`, `description`, imageName) values('No Game No Life', 'Os irmãos Sora e Shiro são inseparáveis, tanto no mundo real quanto no mundo dos jogos. Suas habilidades individuais combinadas fazem deles uma equipe invencível: Sora, com sua intuição e conhecimento surpreendentes...', 'no-game-no-life-collection.jpeg');
insert into collections (`name`, `description`, imageName) values('Nier Automata', '2B e 9S são enviados em uma incursão para dentro do território das máquinas inimigas, eliminando as ameaças para a Resistência local. Os dois contam com a ajuda de Anemone e mais tarde Pascal. Os andróides acabam testemunhando o nascimento...', 'nier-automata-collection.png');
...
insert into manga (`name`, `description`, price, inventory, numPages, volume, id_collection, id_publisher, id_author, imageName) values('Mushoku Tensei', '"Que droga... Eu não tive uma vida satisfatória... Ah, se eu pudesse recomeçar mais uma vez a minha vida..."', 34.90, 40, 180, 1, 1, 1, 1, 'mushoku-tensei-vol1.jpeg');
insert into manga (`name`, `description`, price, inventory, numPages, volume, id_collection, id_publisher, id_author, imageName) values('Konosuba', 'Kazuma Sato era um jovem antissocial e viciado em jogos cujo fim chegou cedo, quando perdeu a vida em um acidente...', 34.90, 50, 168, 1, 2, 1, 2, 'konosuba-vol1.jpeg');
insert into manga (`name`, `description`, price, inventory, numPages, volume, id_collection, id_publisher, id_author, imageName) values('Neon Genesis Evangelion Collectors Edition', 'Uma trama complexa, que aborda temas profundos como a psique humana, seus conflitos internos e relacionamentos...', 74.94, 50, 336, 1, 3, 2, 3, 'evangelion-collection-vol1.jpeg');
insert into manga (`name`, `description`, price, inventory, numPages, volume, id_collection, id_publisher, id_author, imageName) values('No Game No Life', 'Vou transmitir a vocês os romances dos cinco mais falados em Disboard, tá?!!! Em Disboard, um mundo em que tudo era decidido por jogos...', 38.90, 20, 496, 11, 4, 3, 5, 'no-game-no-life-vol11.jpeg');
insert into manga (`name`, `description`, price, inventory, numPages, volume, id_collection, id_publisher, id_author, imageName) values('Yorha: Pearl Harbor Descent Record', 'The distant future. Invaders from another world attack without warning, unleashing a new type of threat: weapons known as "machine lifeforms."...', 74.61, 55, 176, 1, 5, 4, 4, 'yorha-vol1.jpeg');
